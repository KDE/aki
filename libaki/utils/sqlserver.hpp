#ifndef AKI_SQLSERVER_HPP
#define AKI_SQLSERVER_HPP
 ...
 */
class LIBAKI_EXPORT SqlServer : public QObject
{
    Q_OBJECT
public:
    /**
    ...
    virtual ~SqlServer();
    /**
     * Compares two SqlServer's if they are the same based on their content.
     *
     * @param rhs Right hand side of the ==.
     *
     * @return true if the two SqlServer's contents are the same.
     */
    bool operator==(const Aki::SqlServer& rhs) const;
    /**
     * Compares two SqlServer's if they are not the same based on their content.
     *
     * @param rhs Right hand side of the !=.
     *
     * @return true if the two SqlServer's contents are different.
     */
    bool operator!=(const Aki::SqlServer& rhs) const;
    /**
     ...
     *
     * @return List of SqlServer items if any are found. Empty list otherwise.
     */
    static Aki::SqlServer::List serversForIdentity(const Aki::SqlIdentity* identity);
    /**
     ...
     *
     * @param name Name of the new SqlServer.
     * @param identity Identity the new SqlServer will be connected to.
     *
     * @return New create server.
     */
    static Aki::SqlServer* newServer(const QString& name, const Aki::SqlIdentity* identity);
    /**
     ...
     *
     * @return Server that was found; 0 if the server was not found.
     */
    static Aki::SqlServer* findServer(const QString& name, const Aki::SqlIdentity* identity);
    /**
     ...
     *
     * @sa SqlServer::encoding()
     * @sa SqlServer::setEncoding()
     * @sa SqlServer::setDefaultEncoding()
     */
...
protected:
    /**
     * Creates a new SqlServer object.
     *
     * @param parent Parent of the object.
     */
    SqlServer(QObject* parent = 0);
    /**
    ...
    void setId(int id);
private:
    friend class SqlServerPrivate;
    QScopedPointer<SqlServerPrivate> _d;
}; // End of class SqlServer.
} // End of namespace Aki.

Q_DECLARE_METATYPE(Aki::SqlServer*)
