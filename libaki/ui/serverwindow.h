...
private:
    ...
    Q_PRIVATE_SLOT(d, void onInvite(const Aki::Irc::NickInfo &from, const QString &channel))
    ...
    Q_PRIVATE_SLOT(d, void onMode(const Aki::Irc::NickInfo &from, const QString &channel,
                                  const QString &modes, const QString &nick))
    Q_PRIVATE_SLOT(d, void onMode(const Aki::Irc::NickInfo &from, const QString &channel,
                                  const QString &modes, const QStringList &params))
    ...
    Q_PRIVATE_SLOT(d, void onNick(const Aki::Irc::NickInfo &oldNick, const QString &newNick))
    ...
    Q_PRIVATE_SLOT(d, void onNoticeCtcpTime(const Aki::Irc::NickInfo &user, const QString &time))
    Q_PRIVATE_SLOT(d, void onNoticeCtcpVersion(const Aki::Irc::NickInfo &user, const QString &version))
    ...
    Q_PRIVATE_SLOT(d, void onUserJoin(const Aki::Irc::NickInfo &user, const QString &channel))
    Q_PRIVATE_SLOT(d, void onUserPart(const Aki::Irc::NickInfo &user, const QString &channel, const QString &message))
    Q_PRIVATE_SLOT(d, void onUserQuit(const Aki::Irc::NickInfo &user, const QString &message))
