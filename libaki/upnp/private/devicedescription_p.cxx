...
#include "devicedescription_p.hpp"
using namespace Aki;
using namespace Upnp;

DeviceDescriptionPrivate::DeviceDescriptionPrivate()
    : QSharedData(),
...
DeviceDescriptionPrivate::DeviceDescriptionPrivate(const Aki::Upnp::DeviceDescriptionPrivate& other)
    : QSharedData(other),
