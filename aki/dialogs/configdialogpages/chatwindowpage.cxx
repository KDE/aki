...
{
    setupUi(this);
    connect(Aki::ThemeStyleManager::self(), SIGNAL(newThemeAvailable(QString)),
            SLOT(slotNewThemeAvailable(QString)));
...
void
ChatWindowPage::slotNewThemeAvailable(const QString& themeName)
{
    themeListWidget->addItem(themeName);
}
